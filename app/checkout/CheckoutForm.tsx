...
const C = {
  // green = action mint (warp-site --warp-accent); logo = wordmark-only green.
  green: "#4ade80", logo: "#00FF33", ink: "#0b1613", bg2: "#131c2a", bg3: "#1a2332",
  text: "#f0f2f5", text2: "#b0b8c4", text3: "#7a8494", border: "rgba(148,163,184,0.14)",
};
...
const input: React.CSSProperties = {
  width: "100%", boxSizing: "border-box", background: "#0a111b", border: `1px solid ${C.border}`,
...
function WarpMark() {
  return (
    <svg width="78" height="22" viewBox="0 0 660 186" fill="none" aria-label="Warp" style={{ display: "block", marginBottom: 18 }}>
      <path d="M660 185.035H0V0H660V185.035ZM14.0597 171.327H646.141V13.9593H14.0597V171.327Z" fill={C.logo} />
      <path d="M300.976 53.2756L332.509 131.608H351.239L319.705 53.2756H300.976Z" fill={C.logo} />
      <path d="M215.919 131.608H234.648L266.182 53.2756H247.453L215.919 131.608Z" fill={C.logo} />
      <path d="M150.892 107.405L136.431 71.3523H115.593L101.131 107.405L78.2342 53.2756H60.0068L93.047 131.608H109.517L125.987 90.5839L142.457 131.608H158.927L192.017 53.2756H173.739L150.892 107.405Z" fill={C.logo} />
      <path d="M471.856 82.8511C471.816 75.0646 468.691 67.6113 463.166 62.1242C457.642 56.6371 450.167 53.5636 442.381 53.5769H388.502V131.608H405.323V112.125H440.021L447.854 131.608H465.981L456.691 108.41C461.258 105.886 465.065 102.183 467.715 97.6881C470.364 93.1928 471.759 88.0691 471.755 82.8511H471.856ZM405.323 70.3481H442.381C445.71 70.3481 448.903 71.6706 451.257 74.0248C453.611 76.379 454.934 79.572 454.934 82.9013C454.934 86.2307 453.611 89.4236 451.257 91.7778C448.903 94.132 445.71 95.4546 442.381 95.4546H405.323V70.3481Z" fill={C.logo} />
      ...
      <path d="M292.04 76.1794H275.219V94.1557H292.04V76.1794Z" fill={C.logo} />
      <path d="M275.219 131.615H292.04V113.84H275.219V131.615Z" fill={C.logo} />
    </svg>
  );
}
